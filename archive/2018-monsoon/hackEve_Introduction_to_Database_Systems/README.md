...
## Speakers: Daksh Shah and Aniket Pradhan

## Hactivity: Codecademy [Learn SQL](http://bit.ly/CodeSQL)

## Cheatsheets
* https://www.cheatography.com//guslong/cheat-sheets/essential-mysql/pdf/
* https://havel.mojeservery.cz/wp-content/uploads/2015/10/mysql-ref-card.pdf
* https://appletree.or.kr/quick_reference_cards/Databases-SQL-NoSQL/mysql-reference-sheet.pdf

## [Slides](https://docs.google.com/presentation/d/1bBvnog6n-VmfRkmiD4T5s3v5iV83D-on_ZajPjEviD4/edit?usp=sharing)
...
## MondoDB
* [Online Simulator](https://www.jdoodle.com/online-mongodb-terminal)
* [Download MongoDB](https://www.mongodb.com/download-center/v2/community)
* [A nice MongoDB + Python Course](http://freemongodbcourse.com/)
* Official Documentation: [Tutorial](https://docs.mongodb.com/manual/tutorial/) and [CRUD](https://docs.mongodb.com/manual/crud/) (create, read, update, and delete)
* [Awesome MongoDB](https://github.com/ramnes/awesome-mongodb) - A resource of resources

### [MongoDB University](https://university.mongodb.com/)
* [Courses Catalog](https://university.mongodb.com/courses/catalog)
* [M001: MongoDB Basics](https://university.mongodb.com/courses/M001/about): Next Session 9Oct-30Oct
